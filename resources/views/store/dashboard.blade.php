                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                ...
                                                <div class="text-dark fw-bold h5 mb-0"><span>{{ $store->carts()->join('cart_status','cart_status.cart_id','carts.id')->where('status_id','<>','0')->where('status_id','<>','3')->where('status_id','<>','5')->whereNull('cart_status.deleted_at')->count() }}</span></div>
                                            </div>
