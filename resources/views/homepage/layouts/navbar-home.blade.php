...
<nav class="navbar navbar-expand navbar-homepage shadow mb-4 topbar static-top">
                ...
                <div class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="#">
                            <div>
                            <form style="width:100%" class="d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search">
