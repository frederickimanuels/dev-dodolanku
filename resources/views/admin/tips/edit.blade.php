<?php $data=[
    'title' => 'Edit Tips',
    'description' => 'Edit Tips @Dodolanku.id',
...
<section id="createproduct">
    <div class="container create-product-container">
        ...
        @endif
        <form method="POST" action="{{ route('admin.tips.update',$tips->id) }}" enctype="multipart/form-data">
            @csrf
            <h1>Edit Tips</h1>
                ...
                <div class="row">
                    <div class="col-xl-4 col-12 upload-image-text">
                        <div class="upload-text-inner">
                            <h2 class="upload-image-text-h2">Ganti Banner Tips<span style="color:red">*</span></h2>
                ...
                <div class="container">
                    <div class="upload-form-content">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="product-name" name="title" placeholder="Isi judul tips.." value="{{ $tips->title }}">
                                @error('title')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" class="form-control" id="product-product_description" name="description" placeholder="Isi deskripsi tips.." rows="5">{{ $tips->description }}</textarea>
                                @error('description')
